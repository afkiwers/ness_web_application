...
from webapp.api.viewsets import CsrfExemptSessionAuthentication
from ness.api.serializers import EventDataSerializer, ZoneSerializer, NessPacketSerializer
...
class EventDataViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if latest_alarm_state and False:
            # self.serializer_class = OutputEventDataSerializerFullTree
    ...
    def create(self, request, *args, **kwargs):
        ...
        # Command from WebUI
        if request.data.get("input_command"):
            cmds = []
