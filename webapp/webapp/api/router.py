...
from ness.api.router import sub_router as ness_sub_router
from users.api.router import sub_router as user_sub_router

from webapp.api.viewsets import AppViewSet

main_router = routers.DefaultRouter()
main_router.register('app-details', AppViewSet, basename='api-ness-app')
